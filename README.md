...
> Текущая версия README рассчитана на `panel-script-v1 1.3.1`. В архиве уже лежит полный готовый `install.sh`; применять старые hotfix-файлы поверх него не нужно.
